...
extern void Init_Scic_Gpio(void);
extern void Init_Scib_Gpio(void);


#define Pwm_EN_0 GpioDataRegs.GPACLEAR.bit.GPIO29=1;
#define Pwm_EN_1 GpioDataRegs.GPASET.bit.GPIO29=1;

#define Pwm_EN2_0 GpioDataRegs.GPACLEAR.bit.GPIO14=1;
#define Pwm_EN2_1 GpioDataRegs.GPASET.bit.GPIO14=1;

#define DC_ON_0 GpioDataRegs.GPACLEAR.bit.GPIO13=1;
#define DC_ON_1 GpioDataRegs.GPASET.bit.GPIO13=1;

#define DC_ON2_0 GpioDataRegs.GPACLEAR.bit.GPIO16=1;
#define DC_ON2_1 GpioDataRegs.GPASET.bit.GPIO16=1;
extern void CPU_RUN(void);
extern void IPM_BaoHu(void);
extern Uint16 IPM_Fault;
extern Uint16 IPM_Fault_2;
extern void eva_close(void);
extern void eva_open(void);

extern void eva_close_2(void);
extern void eva_open_2(void);
...
extern Uint16 HallAngle_2;
extern Uint16 Speed_run;
#ifdef __cplusplus
}
#endif /* extern "C" */
